...
import org.jboss.forge.addon.as.jboss.as7.JBossAS7ServerController;
...
import org.jboss.forge.addon.as.jboss.eap6.ui.JBossEAP6ConfigurationWizard;
...
/**
 * The application server provider for JBoss EAP6
 * 
 * @author Jeremie Lagarde
 */
public class JBossEAP6Provider extends JBossProvider<JBossEAP6Configuration> implements ConnectionInfo
{
   ...
   @Inject
   private JBossEAP6Configuration configuration;
   ...
   {
      return JBossEAP6ConfigurationWizard.class;
   }

   @Override
   protected JBossEAP6Configuration getConfig()
   {
